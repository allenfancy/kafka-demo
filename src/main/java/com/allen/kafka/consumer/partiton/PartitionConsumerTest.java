package com.allen.kafka.consumer.partiton;
...
public class PartitionConsumerTest {
	...
	public static void main(String[] args) {
		...
		String hosts = "192.168.1.136,192.168.179.135,192.168.179.136";
	...
	private String findNewLeader(String a_oldLeader, String a_topic, int a_partition, int a_port) throws Exception {
		...
		System.out.println("Broker失败后，不能找到一个新的leader节点");
		throw new Exception("Broker失败后，不能找到一个新的leader节点");
	}
